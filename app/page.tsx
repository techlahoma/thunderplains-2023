    ...
    <>
      <header className="tplains-header">
        <section className="flex flex-wrap">
          <div className="text-wrapper">
            ...
            <a className="primary-btn">Save Your Seat!</a>
          </div>
      ...
      <section id="about">
        <div className="row-wrapper flex">
          ...
          <div className="about-copy flex-1">
            ...
            <p>Get ready to dive into a day filled with mind-blowing talks, interactive workshops, and networking opportunities with industry experts. Whether you're a seasoned developer or just starting out, ThunderPlains has something for everyone.</p>
            <p>Explore the latest trends, gain valuable insights, and connect with like-minded individuals who share your passion for technology. Don't let this chance slip away – mark your calendars and get ready to be thunderstruck at ThunderPlains!</p>
          </div>
        </div>
      </section>
      <section id="details">
        ...
        <svg viewBox="0 0 1440 197" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd" d="M4 105.542L1444 0.675171V179.935H4V105.542Z" fill="#931CAD"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M1442 173.229L6.10352e-05 46.3397V197H1442L1442 173.229Z" fill="#5E1279"/>
          <rect x="-37.6386" y="160.284" width="1489.62" height="16" transform="rotate(-4 -37.6386 160.284)" fill="#959596"/>
          <rect x="-37.6386" y="187.173" width="1489.62" height="9" transform="rotate(-4 -37.6386 187.173)" fill="#7EA3B1" />
          <rect x="-37.6386" y="140.395" width="1489.62" height="9" transform="rotate(-4 -37.6386 140.395)" fill="#7EA3B1" />
        </svg>
        </div>
            ...
            <div className="badge-wrapper">
              <div className="icon-wrap">
                <Image
                    ...
                    width={195}
                    height={184}
                    alt="ThunderPlains Badge"
                />
                <span>Learn from the best!</span>
              </div>
              <div className="badge-copy">
                <p>Stay current on the latest in tech from thought leaders across the industry.</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex">
          <div className="ticket-wrap">
            <div className="ticket-info">
              <header>
                <h3>Student<span>Admission</span></h3>
              </header>
              <div className="t-details">
                <h4>Keep the learning going at Thunderplains 2023!</h4>
                <p>From traditional universities, to trade school to teaching yourself freeCodeCamp, if you identify as a student, we think you’re one too!</p>
              </div>
              <footer className="ticket-footer">
                <a href="https://ti.to/techlahoma/thunderplains2023" className="primary-btn">$100 per seat</a>
              </footer>
            </div>
          </div>
          <div className="ticket-wrap">
            <div className="ticket-info">
              <header>
                <h3>General<span>Admission</span></h3>
              </header>
              <div className="t-details">
                <h4>A full day of speakers and talks, networking and more.</h4>
                <p>Individual admission to the full day of Thunderplains conference speakers and lightening talks.</p>
              </div>
              <footer className="ticket-footer">
                <a href="https://ti.to/techlahoma/thunderplains2023" className="primary-btn">$175 per seat</a>
              </footer>
            </div>
          </div>
          <div className="ticket-wrap">
            <div className="ticket-info">
              <header>
                <h3>Professional<span>Admission</span></h3>
              </header>
              <div className="t-details">
                <h4>Empower Employees through Professional Development </h4>
                <p>Help keep the conference affordable for everyone, especially students and those requiring a grant. Government employees should also register at the corporate rate.</p>
              </div>
              <footer className="ticket-footer">
                <a href="https://ti.to/techlahoma/thunderplains2023" className="primary-btn">$275 per seat</a>
              </footer>
            </div>
          </div>
        </div>
      ...
      <section id="sponsors" className="text-center">
        <div className="row-wrapper">
          ...
          <p className="intro">We are grateful to our amazing sponsors who help make our conference happen! Thank you for celebrating tech in Oklahoma and supporting the 10th Anniversary ThunderPlains!</p>
          <div className="sponsor-group gold-sponsors">
            <header className="sponsor-header">
              <h3 id="gold">
                Gold Sponsors
              </h3>
              <a href="https://drive.google.com/file/d/1sXYsG1bOBLhF2yrSkM3BDmJkyYm2aa2J/view?usp=drive_link">Become A Gold Sponsor</a>
            </header>
          ...
          <div className="sponsor-group silver-sponsors">
            <header className="sponsor-header">
              ...
              <a href="https://drive.google.com/file/d/1sXYsG1bOBLhF2yrSkM3BDmJkyYm2aa2J/view?usp=drive_link">Become A Silver Sponsor</a>
            </header>
            <div className="sponsor-list">
              <div className="sponsor-list">
                <div className="sponsor-item">
          ...
          <div className="sponsor-group bronze-sponsors">
            <header className="sponsor-header">
              ...
              <a href="https://drive.google.com/file/d/1sXYsG1bOBLhF2yrSkM3BDmJkyYm2aa2J/view?usp=drive_link">Become A Bronze Sponsor</a>
            </header>
            <div className="sponsor-list">
              <div className="sponsor-item">
                <div className="s-wrap">
          ...
          <div className="sponsor-group local-np-sponsors">
            <header className="sponsor-header">
              ...
              <a href="https://drive.google.com/file/d/1sXYsG1bOBLhF2yrSkM3BDmJkyYm2aa2J/view?usp=drive_link">Become A Local Sponsor</a>
            </header>
            <div className="sponsor-list">
              <div className="sponsor-item">
                <div className="s-wrap">
          ...
          <div className="sponsor-group inkind-sponsors">
            <header className="sponsor-header">
              ...
              <a href="https://drive.google.com/file/d/1sXYsG1bOBLhF2yrSkM3BDmJkyYm2aa2J/view?usp=drive_link">Become An In-Kind Sponsor</a>
            </header>
            <div className="sponsor-list">
              <div className="sponsor-item">
                <div className="s-wrap">
